...
const GrushSettings = (() => {
  ...
  function injectCSS() {
    ...
    st.textContent =
      ...
      '.gs-console{position:relative;width:min(400px,100%);max-height:calc(100dvh - 32px);overflow-y:auto;' +
      ...
      '.gs-trims{display:grid;grid-template-columns:repeat(3,1fr);gap:14px 12px;justify-items:center;margin:18px 0 6px;}' +
      '.gs-grid{display:grid;grid-template-columns:1fr 1fr;gap:18px 14px;justify-items:center;margin-top:18px;}' +
      ...
      '.gk-trim .gk-dial{width:92px;height:92px;}' +
      '.gk-ends{display:flex;justify-content:space-between;width:92px;font-size:8px;letter-spacing:.6px;color:var(--ink-soft,#B0A99C);opacity:.65;margin-top:-2px;}' +
